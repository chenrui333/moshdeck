...
// Development harness: synthetic terminal fixture and authenticated remote SSH.
@main
    ...
    var body: some Scene {
        WindowGroup {
            TabView(selection: $selectedTab) {
                ...
                RemoteTerminalScreen(expanded: expanded).tag("ssh").tabItem { Label("SSH", systemImage: "network") }
                    .toolbar(expanded ? .hidden : .visible, for: .tabBar)
            }
...
private final class HarnessModel: ObservableObject {
    ...
    func runChecks() async {
        ...
        var failures: [String] = []
        let fixture = "\u{1b}c\u{1b}[2J\u{1b}[HASCII\r\n中文 e\u{301} 👩🏽‍💻\r\n\u{1b}[38;2;50;200;100mTRUECOLOR\u{1b}[0m\r\n"
